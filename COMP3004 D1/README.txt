This is the ReadMe file for the MVC Fan Club's implementation of the SCAPES system. 

To build this software follow these steps:

1. Open up a terminal in the installation directory
2. run "make"
3. once make has completed run "./COMP3004_D1"
